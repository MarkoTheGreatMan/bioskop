...
const korisnik_1 = __importDefault(require("./korisnik"));
const projekcija_1 = __importDefault(require("./projekcija"));
const rezervacija_1 = __importDefault(require("./rezervacija"));
const komentar_1 = __importDefault(require("./komentar"));
class UserController {
    constructor() {
        ...
        this.login = (req, res) => {
            ...
            korisnik_1.default.findOne({ username, password })
                .then((user) => {
                if (!user) {
                    return res
                        .status(401)
        ...
        this.updateKorisnik = (req, res) => {
            const k = req.body;
            console.log(k);
            korisnik_1.default.findOneAndUpdate({ username: k.username }, {
                ime: k.ime,
                prezime: k.prezime,
                email: k.email,
                telefon: k.telefon || "",
        ...
        this.getAllProjekcije = (req, res) => {
            projekcija_1.default.find()
                .then((projekcije) => {
        ...
        this.getMyRes = (req, res) => {
            ...
            rezervacija_1.default.find({ ulogovaniKorisnik: username })
                .then((rezervacije) => {
        ...
        this.updateStatus = (req, res) => {
            ...
            rezervacija_1.default.findOneAndUpdate({
                ...
                .then((updated) => {
                if (updated)
                    res.status(200).json({ message: 'Status ažuriran' });
                else
        ...
        this.deleteRezervacija = (req, res) => {
            const id = req.body.id;
            console.log(id);
            rezervacija_1.default.findByIdAndDelete(id)
        ...
        this.getAllKomentari = (req, res) => {
            komentar_1.default.find()
                .then((komentari) => {
        ...
        this.ostaviKomentar = (req, res) => {
            ...
            const noviKomentar = new komentar_1.default({
                username: k.username,
                film: k.film,
                ocena: k.ocena,
                komentar: k.komentar,
